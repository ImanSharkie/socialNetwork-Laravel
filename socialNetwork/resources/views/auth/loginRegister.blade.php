    <div class="container">
        <div class="overlay" id="overlay">
            <div class="sign-in" id="sign-in">
                <img src="/view dashboard/assets/Sin título-1.png" class="logo">
                <h1>Welcome Back!</h1>
                <p>Look at what’s going on in the world right now!</p>
        ...
        <x-jet-validation-errors class="mb-4" />
            <div class="sign-in" id="sign-in-info">
                ...
                <form method="POST" action="{{ route('loginRegister') }}" id="sign-in-form">
                @csrf
